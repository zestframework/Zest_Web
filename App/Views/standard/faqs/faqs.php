        ...
        <div class="container">       
          <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
              ...
              <p class="text-white link-nav"><a href="<?=site_base_url()?>">Home </a>  <span class="lnr lnr-arrow-right"></span> <a href="javascript:void(0)"> Frequency Ask Questions</a></p>
            </div>  
          </div>
        </div>
      </section>
        ...
        <?php
          ...
          <div class="single-post row mt-10">
                ...
                <div class="col-lg-9 col-md-9 ">
                  ...
                  <a class="posts-title" href="<?=site_base_url()?>/faq/view/<?=$value['slug']?>/<?=urlencode($value['title'])?>"><h3><?=$value['title']?></h3></a>
                  <p class="excert">
                    <?= substr($value['scontent'], 0, 255) ?>
                  </p>
                  <a href="<?=site_base_url()?>/faq/view/<?=$value['slug']?>/<?=urlencode($value['title'])?>" class="primary-btn">View More</a>
                </div>
              </div> 
              <hr>                           
      <?php  } ?>
