    ...
    <title>Edit this user -Admin</title>
        ...
        <div class="row clearfix">
             <div class="card">
                <div class="container">
                    ...
                    <form action="<?= site_base_url() ?>/admin/view/user/<?= $args['id'] ?>" method="post">
                        <input type="text" name="id" value="<?=$args['id']?>" hidden>
                        <div class="col-md-12">
                        <p>
                            <b>Role (current => <?=$args['role']?>)</b>
                        </p>
             ...
             <div class="card">
                <div class="container">
                    ...
                    <form action="<?= site_base_url() ?>/admin/view/user/<?= $args['id'] ?>" method="post">
                        ...
                        <div class="col-md-12">
                        <p>
                            <b>Status (current => <?=$args['status']?>)</b>
                        </p>
                        <select class="form-control show-tick" name='st'>
                            <option value='running' disabled>Plese Choose one type</option>
                        ...
                        <br><br><br><br>
                        <input type="submit" name="status" class="btn btn-primary" value="Change status">  
                    </form>                     
                </div>                  
             </div>             
             <div class="card">
                <div class="container">
                    ...
                    <form action="<?= site_base_url() ?>/admin/view/user/<?= $args['id'] ?>" method="post">
                        ...
                        <input type="text" name="name" class="form-control" value="<?= $args['name'] ?>" />
                        </div> 
                        <br><br>
