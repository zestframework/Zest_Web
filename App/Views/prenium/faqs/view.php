...
<meta property="type" content="faq" />
...
<meta property="faq:published_time" content="<?=$args['created']?>" />
            ...
            <div class="col-lg-8 zest-blog-posts">
                              <div class="col-12">
                                <div class="single-blog wow fadeInUp" data-wow-delay="0.1s">
                                    <!-- Post Meta -->
                                    <div class="post-meta">
                                        <h6>By <a href="<?=site_base_url()?>/@<?= (new \Zest\Auth\User())->getByWhere('id',$args['ownerId'])[0]['username'] ?>"><?= (new \Zest\Auth\User())->getByWhere('id',$args['ownerId'])[0]['name'] ?></a></a><a href="#!"><?=$args['created']?></a><a href="#"><a href="<?=site_base_url()?>/community/add">Any Question?</a><p style='color: green'><?=$args['est'];?> read</p><div class="fb-share-button" data-href="<?=site_base_url();?>/faq/view/<?=$args['slug']?>/<?=urlencode($args['title'])?>" data-layout="button_count" data-size="large" data-mobile-iframe="true"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div></h6>
                                    </div>
                                    <!-- Post Excerpt -->
