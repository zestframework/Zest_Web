...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <section class="blog-area section_padding_100">
        ...
        <?php
          $tItems = count(model('Pages')->pageWhere('type','blog'));
          $page = $args['page'];
          $limit = 6;
          $url = "/blogs/";
          if($page == 1){
          ...
          $pages = model('Pages')->viewLimitedPagesBlog($limit,$start);
            foreach ($pages as $page => $value) { ?>
                            <div class="col-12">
                                <div class="single-blog wow fadeInUp" data-wow-delay="0.1s">
                                    ...
                                    <!-- Read More btn -->
                                    <a href="<?=site_base_url()?>/blog/view/<?=$value['slug']?>/<?=urlencode($value['title'])?>" >Read More</a>
                                </div>
                            </div>
